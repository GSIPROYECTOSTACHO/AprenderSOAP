...
public class MainVideos extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnVideo1=(ImageButton)findViewById(R.id.video1);
        ...
        btnPausar=(Button)findViewById(R.id.btn_pausar);
        btnPausar.setOnClickListener(this);

        sound = MediaPlayer.create(this,R.raw.video1);
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.main_videos, menu);
        return true;
    }
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.video1:
                startActivity(new Intent(MainVideos.this, Video1.class));
                break;
